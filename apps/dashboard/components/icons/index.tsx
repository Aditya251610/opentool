...
export function LinearIcon({ size = 20, className = '', style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="96 96 320 320" fill="currentColor" className={className} style={style}>
...
export function GmailIcon({ size = 20, className = '', style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" className={className} style={style}>
      <path d="M2 11.956c0-3.485 0-5.227.678-6.558A6.956 6.956 0 015.397 2.678C6.728 2 8.471 2 11.956 2h8.088c3.485 0 5.228 0 6.558.678a6.956 6.956 0 012.72 2.72C30 6.728 30 8.47 30 11.956v8.088c0 3.485 0 5.228-.678 6.558a6.956 6.956 0 01-2.72 2.72C25.272 30 23.529 30 20.044 30h-8.088c-3.485 0-5.228 0-6.559-.678a6.956 6.956 0 01-2.72-2.72C2 25.272 2 23.529 2 20.044V11.956z" fill="white"/>
      <path d="M22.052 8.523l-5.988 4.672L9.94 8.523v.001l.008.006v6.543l5.948 4.773 6.056-4.589V8.523z" fill="#EA4335"/>
      <path d="M23.623 7.386l-1.572 1.137v6.735l4.948-3.798V9.17s-.6-3.268-3.376-1.784z" fill="#FBBC05"/>
      <path d="M22.051 15.258v8.735h3.792s1.08-.112 1.157-1.341V11.459l-4.949 3.799z" fill="#34A853"/>
      <path d="M9.948 24v-8.927l-.008-.006L9.948 24z" fill="#C5221F"/>
      <path d="M9.94 8.524L8.376 7.394C5.602 5.91 5 9.177 5 9.177v2.288l4.94 3.601V8.524z" fill="#C5221F"/>
      <path d="M9.94 8.524v6.543l.008.006-.008-6.549z" fill="#C5221F"/>
      <path d="M5 11.467v11.192c.076 1.231 1.157 1.341 1.157 1.341h3.792l-.008-8.933L5 11.467z" fill="#4285F4"/>
    </svg>
  )
}
...
export function GoogleCalendarIcon({ size = 20, className = '', style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="none" className={className} style={style}>
      ...
      <path d="M0 195.368v40.421C0 246.956 9.044 256 20.211 256h40.421l6.225-30.316-6.225-30.316-33.033-5.172L0 195.368z" fill="#188038"/>
      <path d="M256 60.632V20.211C256 9.044 246.956 0 235.789 0h-40.421c-3.689 15.036-5.533 26.101-5.533 33.196 0 7.094 1.844 16.24 5.533 27.436 13.41 3.84 23.515 5.76 30.316 5.76s18.169-1.92 30.316-5.76z" fill="#1967D2"/>
...
export function ResendIcon({ size = 20, className = '', style }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 1800 1800" fill="currentColor" className={className} style={style}>
