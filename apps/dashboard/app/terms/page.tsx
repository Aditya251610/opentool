  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-8">
        ...
        <Link href="/docs" className="text-[14px] text-[rgba(255,255,255,0.5)] hover:text-white transition-colors">Docs</Link>
      </div>
      <div className="flex items-center gap-3">
        ...
        <Link
          ...
          className="h-8 px-4 rounded-lg bg-white text-black text-[13px] font-medium flex items-center hover:bg-[#e0e0e0] transition-colors"
        >
...
function Footer() {
  return (
    <footer className="border-t border-[#1A1A1A]">
      <div className="max-w-[860px] mx-auto px-6 md:px-10 pt-12 pb-8">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          <span className="text-[12px] text-[rgba(255,255,255,0.2)]">© 2025 OpenTool · MIT License · Open source</span>
          <div className="flex items-center gap-4">
            <Link href="/privacy" className="text-[12px] text-[rgba(255,255,255,0.3)] hover:text-white transition-colors">Privacy</Link>
            <Link href="/terms" className="text-[12px] text-[rgba(255,255,255,0.3)] hover:text-white transition-colors">Terms</Link>
          </div>
        </div>
      </div>
    </footer>
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-[860px] mx-auto px-6 md:px-10 pt-32 pb-24">
        ...
        >
          <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-[rgba(255,255,255,0.25)] mb-4">Legal</p>
          <h1 className="text-[36px] sm:text-[44px] font-bold tracking-[-0.03em] leading-[1.1] mb-3">Terms of Service</h1>
          <p className="text-[15px] text-[rgba(255,255,255,0.4)] mb-2">Last updated: April 9, 2025</p>
        ...
        <div className="flex gap-16">
          ...
          <aside className="hidden lg:block w-[180px] flex-shrink-0">
            <div className="sticky top-[80px]">
              <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-[rgba(255,255,255,0.2)] mb-3">On this page</p>
                ...
                {sections.map(({ id, label }) => (
                  <a
                    ...
                    className={`text-[12px] transition-colors ${
                      activeSection === id ? 'text-white' : 'text-[rgba(255,255,255,0.3)] hover:text-[rgba(255,255,255,0.6)]'
                    }`}
                  >
                    {label}
                  </a>
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              <p className="text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8]">
              ...
              <Section id="acceptance" title="1. Acceptance of Terms">
                <p className="text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8]">
                  ...
                  <Link href="/privacy" className="text-[#0070F3] hover:underline">Privacy Policy</Link>.
                  If you are using the Service on behalf of an organization, you represent that you have the authority to bind that organization to these Terms.
                </p>
                <p className="text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8] mt-3">
              ...
              <Section id="description" title="2. Service Description">
                ...
                <ul className="list-none space-y-3 mt-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8]">
                      <span className="mt-[10px] w-1 h-1 rounded-full bg-[rgba(255,255,255,0.2)] flex-shrink-0" />
                      {item}
                    </li>
                  ))}
                </ul>
              ...
              <Section id="accounts" title="3. Accounts & Authentication">
                ...
                <p className="text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8] mt-4">
              ...
              <Section id="acceptable-use" title="4. Acceptable Use">
                <p className="text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8]">You agree not to use the Service to:</p>
                <ul className="list-none space-y-3 mt-4">
                  {[
              ...
              <Section id="third-party" title="5. Third-Party Integrations">
                <p className="text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8]">
                  The Service allows you to connect third-party services (GitHub, Google, Slack, Notion, Linear, Stripe, Vercel, Resend) through OAuth authorization. By connecting a third-party service:
                </p>
                <ul className="list-none space-y-3 mt-4">
                  {[
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="border-b border-[rgba(255,255,255,0.06)]">
                        <th className="px-4 py-3 text-[12px] font-semibold uppercase tracking-[0.08em] text-[rgba(255,255,255,0.3)]">Endpoint</th>
                        <th className="px-4 py-3 text-[12px] font-semibold uppercase tracking-[0.08em] text-[rgba(255,255,255,0.3)]">Limit</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        ...
                        <tr key={endpoint} className="border-b border-[rgba(255,255,255,0.03)]">
                          <td className="px-4 py-3 text-[14px] text-[rgba(255,255,255,0.55)]">{endpoint}</td>
                          <td className="px-4 py-3 text-[14px] text-[rgba(255,255,255,0.4)]">{limit}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              <Section id="intellectual-property" title="7. Intellectual Property">
                <p className="text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8]">
                  ...
                  <a href="https://github.com/Aditya251610/opentool/blob/main/LICENSE" target="_blank" className="text-[#0070F3] hover:underline">MIT License</a>.
              ...
              <Section id="contact" title="14. Contact">
                ...
                <div className="mt-4 p-4 rounded-xl border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.02)]">
                  <p className="text-[14px] text-[rgba(255,255,255,0.6)]">
                    ...
                    <a href="mailto:legal@opentool.space" className="text-[#0070F3] hover:underline">legal@opentool.space</a>
                  </p>
                  <p className="text-[14px] text-[rgba(255,255,255,0.6)] mt-2">
                    <span className="text-white font-medium">GitHub:</span>{' '}
                    <a href="https://github.com/Aditya251610/opentool/issues" target="_blank" className="text-[#0070F3] hover:underline">Open an issue</a>
                  </p>
                </div>
              </Section>

              <div className="h-px bg-[rgba(255,255,255,0.06)] mt-12" />
              <p className="text-[13px] text-[rgba(255,255,255,0.25)] leading-[1.8] mt-6">
...
function Section({ id, title, children }: { id: string; title: string; children: React.ReactNode }) {
  return (
    <section id={id} className="scroll-mt-24">
      <h2 className="text-[20px] font-semibold tracking-[-0.02em] mb-4">{title}</h2>
      {children}
    </section>
  )
}
