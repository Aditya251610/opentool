    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-[860px] mx-auto px-6 md:px-10 pt-32 pb-24">
        ...
        >
          ...
          <h1 className="text-[36px] sm:text-[44px] font-bold tracking-[-0.03em] leading-[1.1] mb-3">Privacy Policy</h1>
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              <p className="text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8]">
                OpenTool (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is an open-source MCP (Model Context Protocol) server platform.
                This Privacy Policy explains how we collect, use, store, and protect your information when you use the
                OpenTool hosted service at opentool.space, our dashboard, CLI, SDKs, and related services (collectively, the &quot;Service&quot;).
              </p>
              <p className="text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8]">
              ...
              <Section id="data-storage" title="3. Data Storage & Security">
                ...
                <ul className="list-none space-y-3 mt-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8]">
                      <span className="mt-[10px] w-1 h-1 rounded-full bg-[#0070F3] flex-shrink-0" />
                      {item}
                    </li>
                  ))}
                </ul>
              ...
              <Section id="third-party" title="4. Third-Party Services">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mt-4">
                  {['GitHub', 'Google (Gmail, Calendar)', 'Notion', 'Slack', 'Linear', 'Stripe', 'Vercel', 'Resend'].map((p) => (
                    <div key={p} className="text-[13px] text-[rgba(255,255,255,0.4)] bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.06)] rounded-lg px-3 py-2">{p}</div>
                  ))}
                </div>
                <p className="text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8] mt-4">
              ...
              <Section id="data-retention" title="6. Data Retention">
                <ul className="list-none space-y-3">
                  {[
                    ...
                    <li key={label} className="text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8]">
              ...
              <Section id="your-rights" title="7. Your Rights">
                <p className="text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8]">You have the right to:</p>
              ...
              <Section id="contact" title="11. Contact">
                ...
                <div className="mt-4 p-4 rounded-xl border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.02)]">
                  <p className="text-[14px] text-[rgba(255,255,255,0.6)]">
                    ...
                    <a href="mailto:privacy@opentool.space" className="text-[#0070F3] hover:underline">privacy@opentool.space</a>
                  </p>
...
function Subsection({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="mb-4">
      <h3 className="text-[15px] font-medium text-[rgba(255,255,255,0.8)] mb-1.5">{title}</h3>
      <p className="text-[15px] text-[rgba(255,255,255,0.55)] leading-[1.8]">{children}</p>
    </div>
  )
}
