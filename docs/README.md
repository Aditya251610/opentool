...
| [Tools](./tools.md) | Every supported tool and what it can do |
| [MCP Integration](./mcp-integration.md) | Connect Claude, Cursor, or any MCP client |

## Building & Extending

| Doc | What it covers |
|-----|----------------|
| [SDK Reference](./sdk-reference.md) | TypeScript and Python SDK usage |
| [CLI Reference](./cli-reference.md) | Terminal-based tool management |
