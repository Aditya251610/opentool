...
OpenTool ships with 10 providers and 23 tool actions. Each tool is a discrete action your AI agent can call via MCP.
...
| [PostgreSQL](#postgresql) | API Key | 1 | ✅ Stable |
