...
* align frontend with backend — 24 providers, 120 tools ([58df9e4](https://github.com/Aditya251610/opentool/commit/58df9e4323b55ed3b3701d43a276072417ad2051))


### Documentation

* add org/team support documentation ([81f8a4c](https://github.com/Aditya251610/opentool/commit/81f8a4cbd85197a8951014f909bc384fcce75afd))
* comprehensive update — 26 providers, 133 tools ([49f3607](https://github.com/Aditya251610/opentool/commit/49f36074828f19feff1ef947d3649ec272c6c0b4))
...
- **Infra**: CI pipeline builds dashboard, CLI, and SDK; Dockerfile optimized with non-root user; `install.sh` curl installer
- **Docs**: CLI reference, quickstart, tools guide, CODE_OF_CONDUCT.md, CONTRIBUTING.md, PRIVACY.md

### Bug Fixes

- Default server URL changed from localhost to hosted backend
...
- **Auth**: OAuth 2.0 broker with PKCE for all providers; API key authentication with SHA-256 hashing
...
- **SDK**: TypeScript SDK with zero `any` types; Python SDK published to PyPI
- **Infra**: Docker + docker-compose with health checks; Prisma schema with 7 models
